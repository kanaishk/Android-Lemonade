    ...
    private fun setViewElements() {
        ...
        when(lemonadeState) {
            SELECT -> {
                ...
                lemonImage?.contentDescription = R.string.lemon_select.toString()
                textAction.setText(R.string.lemon_select)
            }
            SQUEEZE -> {
                lemonImage?.setImageResource(R.drawable.lemon_squeeze)
                lemonImage?.contentDescription = R.string.lemon_squeeze.toString()
                textAction.setText(R.string.lemon_squeeze)
            }
            DRINK -> {
                lemonImage?.setImageResource(R.drawable.lemon_drink)
                lemonImage?.contentDescription = R.string.lemon_drink.toString()
                textAction.setText(R.string.lemon_drink)
            }
            RESTART -> {
                lemonImage?.setImageResource(R.drawable.lemon_restart)
                lemonImage?.contentDescription = R.string.lemon_empty_glass.toString()
